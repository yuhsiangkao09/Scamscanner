try {
  ...
  console.warn("[SurfFish] Failed to preload i18n helpers in background context.", error);
}
...
async function loadSettings() {
  ...
  userSiteDecisions = stored.userSiteDecisions && typeof stored.userSiteDecisions === "object"
    ...
    : {};
  const shouldSeedDefaults = !stored._surfphishInstalled
    || typeof stored.apiBaseUrl !== "string"
    || typeof stored.scanTimeout !== "number"
    || typeof stored.protectionEnabled !== "boolean"
    || typeof stored.uiLanguage !== "string"
    || !Array.isArray(stored.whitelistRules);
